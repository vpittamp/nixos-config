...
- [ ] T037 [P] [US2] Implement project CRUD handler in home-modules/tools/monitoring-panel/project_crud_handler.py (handle edit requests from Eww)
- [ ] T038 [US2] Add inline edit form widget to eww-monitoring-panel.nix Projects tab (pre-filled fields, Cancel/Save buttons, conditional remote fields)
