...
**NOTE:** This workflow assumes the user has already created a feature worktree using `i3pm worktree create --from-description "..."`. The specs directory is pre-created during worktree setup for parallel Gemini CLI sessions.
