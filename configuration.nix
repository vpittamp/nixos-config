...

{
  ...
  # Enable 1Password with full integration
  programs._1password.enable = true;
  programs._1password-gui = {
    enable = true;
    # Required for KDE Plasma system authentication
  ...
  # Enable touchpad support with macOS-like gestures
  services.libinput = {
    enable = true;
    touchpad = {
      tapping = true;
      ...
      accelSpeed = "0.3";           # Smooth acceleration
      tappingButtonMap = "lrm";     # 1 tap = left, 2 = right, 3 = middle
    };
  };
