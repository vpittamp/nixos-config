...
let
  ...
  # Order activities to match keyboard shortcuts: Meta+1=Monitoring, Meta+2=NixOS, Meta+3=Stacks, Meta+4=Backstage, Meta+5=Devcontainer
  activityIds = [ "monitoring" "nixos" "stacks" "backstage" "devcontainer" ];
