...
let
  ...
  # Order activities to match keyboard shortcuts: Meta+1=NixOS, Meta+2=Stacks, Meta+3=NixOS Worktree, Meta+4=Stacks Worktree
  activityIds = [ "nixos" "stacks" "nixos-worktree" "stacks-worktree" ];
