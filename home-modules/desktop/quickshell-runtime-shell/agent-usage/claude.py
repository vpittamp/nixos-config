#!/usr/bin/env python3
# Ported from Omarchy (basecamp/omarchy, quattro branch, bin/omarchy-agent-usage-claude),
...
def cache_root() -> Path:
  root = Path(os.environ.get("XDG_CACHE_HOME", Path.home() / ".cache")) / "quickshell-runtime-shell" / "agent-usage"
