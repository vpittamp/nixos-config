#!/usr/bin/env python3
# Ported from Omarchy (basecamp/omarchy, quattro branch, bin/omarchy-agent-usage-codex),
# MIT License, Copyright (c) Basecamp / David Heinemeier Hansson. Only the cache
# location was changed; the record contract is unchanged so the shell panel
# and any future collector share one shape.
...
def cache_root():
  root = Path(os.environ.get("XDG_CACHE_HOME") or (Path.home() / ".cache")) / "quickshell-runtime-shell" / "agent-usage"
