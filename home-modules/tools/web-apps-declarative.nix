...
let
  ...
  makeLauncher = id: app: pkgs.writeScriptBin "webapp-${id}" ''
    ...
    MAIN_CHROMIUM_PROFILE="$HOME/.config/${browserConfigDir}/Default"
...
EOF
    ...
    ln -sf "$HOME/.config/${browserConfigDir}/NativeMessagingHosts/com.1password.1password.json" \
      "$PROFILE_DIR/NativeMessagingHosts/com.1password.1password.json" 2>/dev/null || true
    ln -sf "$HOME/.config/${browserConfigDir}/NativeMessagingHosts/com.1password.browser_support.json" \
