...
- Runtime entrypoints in `services/openshell-agent-runtime/main.py`: `_allocate_local_port()` (line ≈ 2258), `_local_devserver_runner()` (line ≈ 2346), `_launch_local_devserver()` (line ≈ 2462).
